...
QT_MOC_LITERAL(5, 50, 12), // "setXRotation"
QT_MOC_LITERAL(6, 63, 12) // "setYRotation"

    },
    "Viewport\0xRotationChanged\0\0angle\0"
    "yRotationChanged\0setXRotation\0"
    "setYRotation"
};
...
void Viewport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewport::xRotationChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Viewport::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Viewport::yRotationChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Viewport::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void Viewport::yRotationChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
